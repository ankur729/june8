                                    ...
                                    for (var i = 0; i < data.length; i++) {
                                        ...
                                        if (data[i].orders.length > 0) {
                                            ...
                                            for (var j = 0; j < data[i].orders.length; j++) {
                                                ...
                                                if (data[i].orders[j].order_status == 'pending') {

                                                    pending_order++;
                                                }
                                                if (data[i].orders[j].order_status == 'complete') {

                                                    completed_order++;
                                                }
                                                if (data[i].orders[j].order_status == 'cancelled') {
                            ...
                            if (err || !data) console.log("No  data found");
                                ...
                                for (var a = 0; a < cook_info.length; a++) {
                                    ...
                                    for (var b = 0; b < orders.length; b++) {
                                        ...
                                        for (var c = 0; c < orders[b].items.length; c++) {
                                            ...
                                            if (orders[b].items[c].cook_id == cook_info[a]._id) {
                                                ...
                                                if (orders[b].items[c].food_total_price) {
                                    ...
                                    if (is_valid_income == true) {
                                        ...
                                        income_info_obj.cook_total_orders = tot_orders;
                                ...
                                db.user_infos.find({
                                    ...
                                    function (err, sub_order) {
                                        ...
                                        var final_data = [];
                                        var final_obj = {};
                                        for (var m = 0; m < sub_order_detail.length; m++) {

                                            for (var j = 0; j < income_info_arr.length; j++) {
